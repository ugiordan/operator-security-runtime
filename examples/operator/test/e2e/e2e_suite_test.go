...
var (
	...
	projectImage = "example.com/k8s-serviceaccount-hijacking-protection:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting k8s-serviceaccount-hijacking-protection integration test suite\n")
